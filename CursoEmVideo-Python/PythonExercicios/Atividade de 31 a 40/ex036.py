...
if saporcento >= casa / mensalidade:
    print('Fizemos a cotação do sua\033[1;34m Renda Mensal,\033[m com o valor da\033[1;33m Residência\033[m '
          'e junto com a\033[1;35m Estipulação Anual de Pagamento\033[m e o resultado é que:'
          '\nSeu Emprestimo foi\033[1;32m Liberado\033[m!')
elif saporcento <= casa / mensalidade:
    print('Fizemos a cotação do sua\033[1;34m Renda Mensal,\033[m com o valor da\033[1;33m Residência\033[m '
          'e junto com a\033[1;35m Estipulação Anual de Pagamsento\033[m e o resultado é que'
